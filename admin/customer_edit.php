...
try {
    ...
    $error = 'خطأ في جلب بيانات العميل';
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $result = $stmt->execute([
            ...
            $data['address'], $data['city'], $data['driver_license'], $data['license_expiry'],
            $data['date_of_birth'], $data['status'], $data['notes'], $customerId
        ]);
...
<div class="main-content">
    <div class="top-bar">
        <div class="welcome-text">
            <h5><i class="fas fa-user-edit me-2"></i>تعديل بيانات العميل</h5>
        </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="city" class="form-control">
                        <?php 
                        global $PALESTINIAN_CITIES;
                        foreach ($PALESTINIAN_CITIES as $city): 
                        ?>
                        <option value="<?php echo $city; ?>" 
                                <?php echo ($customer['city'] === $city) ? 'selected' : ''; ?>>
                            <?php echo $city; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select name="status" class="form-control" required>
                        ...
                        <option value="<?php echo $key; ?>" 
                                <?php echo ($customer['status'] === $key) ? 'selected' : ''; ?>>
                            <?php echo $value; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
